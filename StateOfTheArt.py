...
#match_data = match_data.tail(3500)
...
train_index = features[features['season'].to_numpy() != '2015/2016'].index.to_numpy()
test_index = features[features['season'].to_numpy() == '2015/2016'].index.to_numpy()
X_train_calibrate, X_test = features.loc[train_index], features.loc[test_index]
y_train_calibrate, y_test = labels.loc[train_index], labels.loc[test_index]
