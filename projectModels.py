...
#match_data = match_data.tail(3000)
...
labels = inputs.loc[:,'label']
features = inputs.drop(['label','League_21518.0', 'League_24558.0','B365_Win', 'B365_Draw', 'B365_Defeat', 'BW_Win', 'BW_Draw',
     'BW_Defeat'], axis = 1)
...
#remove 'season' column from the sets
...
#     w = accuracy_score(y_pred, y_test)
#     print(i)
#     print(w)
